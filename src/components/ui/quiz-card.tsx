                ...
                <div className="flex-1 space-y-4">
                            ...
                            {actionDisabled
                                ? quiz.status === "Upcoming"
                                    ...
                                    : quiz.status === "Completed"
                                      ? "Submission locked"
                                      : "No longer open to attempt"
                                : quiz.isSebRequired
                                  ? "Secure launch required"
                                  : "Ready to attempt"}
                        </div>
                    </div>
                    ...
                    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                        <InfoTile
                            icon={CalendarDays}
                            label="Published"
                            value={new Date(quiz.publishAt).toLocaleString()}
                        />
                        <InfoTile
                            icon={Clock3}
                            label="Due"
                            value={new Date(quiz.dueAt).toLocaleString()}
                        />
                        <InfoTile
                            icon={CheckCircle2}
                            label="Marks"
                            value={`${quiz.totalMarks} total`}
                        />
                        <InfoTile
